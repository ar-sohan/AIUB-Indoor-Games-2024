...
public class AdminPlayer extends JFrame implements ActionListener {
    ...
    private String[] column = { "Names", "Student Id", "Gender", "Interest", "Payment"};
    ...
    public AdminPlayer(String name,String fid,String uName) {
        super("Welcome to Student List");
		this.name= name;
		this.fid = fid;
		this.uName= uName;
        panel = new JPanel();
        ...
        // volunteer table:
        tableTitle = new JLabel("List Of Players For This Event");
    ...
    public static void main(String[] args) {
       // AdminPlayer ad = new AdminPlayer();
        //ad.setVisible(true);
    }
}
