...
public class VolunteerDuty extends JFrame implements ActionListener {
    ...
    public VolunteerDuty(String name,String id, String uName) {
        ...
        // meeting table
        table1Title = new JLabel("Duty Schedule Today");
		...
		JLabel R1C4= new JLabel("LinesMan");
		...
		JLabel R2C4= new JLabel("Operator");
		...
		JLabel R3C4= new JLabel("Manager");
    ...
    public static void main(String[] args) {
       // VolunteerDuty ad = new VolunteerDuty();
        //ad.setVisible(true);
    }
}
